...
urlpatterns = [
    ...
    path('', views.dashboard, name='dashboard'),
     ...
     # Backup / Restore
    path('backup/create/', views.create_db_backup, name='create_db_backup'),
    path('backup/restore/', views.restore_db_backup, name='restore_db_backup'),
    ...
    # Manage product colors (stock)
    path('product/<int:pk>/colors/', views.manage_product_colors, name='manage-product-colors'),

    # AJAX: create color
    path('api/colors/add/', views.color_create_ajax, name='api_color_add'),
]
